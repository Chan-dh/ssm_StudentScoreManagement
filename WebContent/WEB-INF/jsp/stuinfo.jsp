...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <a class="navbar-brand" href="${pageContext.request.contextPath }/indexs">Home</a>
        ...
        <div id="right" class="container mr-0 bg-light" >
            <div class="container" >
                    <div class="mx-3">
                        ...
                        <h5 class="text-muted ml-5 mt-1">你好!${Stu_SESSION.sname }同学</h5>
                    </div>
                    ...
                    <div class="container mt-5">
                        ...
                        <table class="table table-hover table-bordered">
                          ...
                          <tbody>
                          	<c:if test="${not empty Stu_SESSION }">
                            <tr>
                              <td>${Stu_SESSION.sno }</td>
                              <td>${Stu_SESSION.ssex }</td>
                              <td>${Stu_SESSION.sname }</td>
                              <td>${Stu_SESSION.score }</td>
                            </tr>
                            </c:if>
                            <tr>
                              <td>/</td>
