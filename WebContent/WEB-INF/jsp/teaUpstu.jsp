            ...
            <div class="container">
                ...
                <div class="container" >
                    <div class="container">
                        ...
                        <form action="${pageContext.request.contextPath }/teaUpstucg" method="POST">
                          ...
                          <div class="form-group">
                            <label>性别:</label>
                            <input type="text" class="form-control" name="ssex" placeholder="性别" ">
                          </div>
                          <div class="form-group">
                            <label>姓名:</label>
                          ...
                          <div class="form-group">
                            <label>成绩:</label>
                            <input type="text" class="form-control"   name="score1" placeholder="成绩" >
                          </div>
                          <div class="form-group">
                            <label>密码:</label>
